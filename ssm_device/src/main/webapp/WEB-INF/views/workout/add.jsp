        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">新增工种租赁合同</h3>
...
<script>
    ...
    $(function () {
        ...
        $("#deviceId").change(function () {
            var id = $(this).val();
            if(id) {
                $.get("/workOut/rent/workType.json",{'id':id}).done(function(resp){
                    ...
                    success: function (data) {
                        if(data.status == 'success') {
                            layer.confirm("保存成功",{btn:['继续添加','打印合同']},function(){
                                ...
                                window.location.href = "/workOut/rent/"+data.message;
                            });
                        }
                    },
                    error: function () {
